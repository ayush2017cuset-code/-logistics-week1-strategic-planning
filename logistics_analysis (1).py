...
This script implements the proposed analytical approach described in the
...
segmentation (clustering), and route optimisation for last-mile delivery.
"""
...
def optimise_routes(df, warehouse_location):
    """Generate a delivery route for each zone cluster using a
    nearest-neighbour ordering by distance from the warehouse."""
    routes = {}
